...
if number == 1:
    print(" nombre est égale à 1")
else:
    print("nombre est différent de 1")
...
if (number % 2) == 0:
    print(" chiffre est pair")
else:
    print(" chiffre est impair")
...
if number % 3:
    print(" chiffre n'est pas divisible par 3")
else:
    print("chiffre est divisible par 3")
...
if number >= 5:
    print(" chiffre est supérieur a 5")
else:
    print(" chiffre est inférieur a 5")
...
if number <= 49:
    print("nombre est compris entre 0 et 49 inclus")
else: 
    print("nombre n'est pas compris entre 0 et 49 inclus")
...
if number <= 33:
    print(" nombre est compris entre 0 et 33 inclus")
elif number <= 34 >= 66:
    print(" nombre est compris entre 34 et 66 inclus")
elif number >= 66:
    print(" nombre n'est pas compris entre 0 et 66 inclus")
...
if b < a :
    print(" nombre a est supérieur au nombre b")
elif b > a:
    print(" nombre a est inférieur au nombre b")
elif a == b:
    print(" deux nombres a et b sont égaux")
